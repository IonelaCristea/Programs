 ...
 * File:MorseCode.java
 * ------------------- 
 * This program has two ways of translating normal text to the More code.
 * Both of the version have the same output.
 * The program ask the user to insert a text, and then outputs that text
 * in More code.
 */
